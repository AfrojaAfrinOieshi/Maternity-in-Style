...
<html>
    ...
    <body>
            ...
            <?php $i=0;
             ...
             $query = "select * from items where type=1 ";
                                    ...
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        ...
                                        <?php
                                            ...
                                            if(check_if_added_to_cart($i)){
                                                ...
                                                ?>
                                                <a href="cart_add_babyfood.php?id=<?php echo $i?>" class="btn btn-block btn-primary" name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
                                                <?php
                                            }
                                        }
                                        ?>
