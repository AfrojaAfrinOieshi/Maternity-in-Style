<?php
    ...
    ?>
        ...
        var btn = document.getElementById("ThisLink");
        btn.disabled = true;
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>Tk <?php echo $sum;?>/-</th><th><a  href="success.php?id" id="ThisLink" class="btn btn-primary">Place Order</a></th>
                            <tr>
