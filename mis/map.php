		...
		<div class="contact-wrap">
			<div class="contact-in">
				...
				<ul>
					...
					<li><a href="https://www.linkedin.com/signup" target="_blank"><i class="fab fa-linkedin-in" aria-hidden="true"></i></a></li>
				</ul>
			</div>
            <?php
           ...
           ?>
			<div class="contact-in">
				...
				<form method="post" action="contact_us.php">
					<input type="text"  name="name" placeholder="name" class="contact-in-input" value="<?php echo $row['name']; ?>"readonly>
					<input type="text"  name="email" placeholder="email" class="contact-in-input" value="<?php echo $row['email']; ?>"readonly>
